...
export const handlers = [
    ...
    http.get(getUrl("/dashboards/1"), ({ request }) => {
    ...
    http.get(
        getUrl(
            "/api/dashboard/data/DashboardItemGetAction?dashboardId=1&itemId=gridDashboardItem1&query=%7B%22LimitVisibleData%22%3Atrue%7D"
        ),
        ({ request }) => {
